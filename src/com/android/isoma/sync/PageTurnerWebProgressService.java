 ...
 */
package com.android.isoma.sync;
...
public class PageTurnerWebProgressService implements ProgressService {
	...
	public List<BookProgress> getProgress(String fileName) {
		...
		if ( "".equals( this.userId) || "".equals(fileName) ) {
			LOG.debug( "Empty username or filename. Aborting com.android.isoma.sync. (" + this.userId + " / " + fileName + ")" );
			return null;
		}
	...
	public class SSLHttpClient extends DefaultHttpClient {
		...
		private SSLSocketFactory newSSlSocketFactory() {
			try {
				...
				InputStream in = context.getResources().openRawResource(R.raw.isoma);
				try {
